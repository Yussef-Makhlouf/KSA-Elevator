      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-[100px]">
        <div className="flex flex-col items-end gap-4 sm:gap-6 md:gap-8 lg:gap-12 max-w-[1695px] mx-auto">
          ...
          <p className="text-black text-xs sm:text-sm md:text-base lg:text-lg font-medium leading-5 sm:leading-6 md:leading-7 lg:leading-8 text-right w-full">
            مصاعد إعمار المتحدة مؤسسة سعودية متخصصة في بيع وتوريد وتركيب وصيانة المصاعد الكهربائية والهيدروليكية، بخبرة
            تتجاوز 18 عامًا. تلتزم بالجودة والسلامة، وتنفذ مشاريع ناجحة في القطاعات الحكومية والتجارية والسكنية.
          </p>
        </div>
          ...
          {[
            {
              ...
              label: "عامًا من الخبــرة في قطاع المصــاعد",
              number: "4"
            },
            {
              image: "/abo2.png",
              count: counts.projects,
              label: "مشــروع مصعــد مكتمل",
              number: "3"
            },
            {
              image: "/abo3.png",
              count: counts.reviews,
              label: "تقييــم إيجــابي من عملائنا",
              number: "2",
              isK: true
            },
            {
              image: "/abo4.png",
              count: counts.awards,
              label: "جائــزة وشهــادة اعتمــاد",
              number: "1"
            }
          ].map((item, index) => (
